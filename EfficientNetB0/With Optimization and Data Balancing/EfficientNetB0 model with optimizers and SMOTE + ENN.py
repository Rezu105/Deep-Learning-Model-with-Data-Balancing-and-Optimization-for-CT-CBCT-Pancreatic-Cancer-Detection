...
from imblearn.combine import SMOTEENN   # ✅ Combined technique
...
# Apply SMOTE + ENN (Hybrid)
print("[INFO] Applying SMOTE + ENN for data balancing...")
X_2d = images.reshape(len(images), -1)  
smote_enn = SMOTEENN(random_state=random_state)
X_res, y_res = smote_enn.fit_resample(X_2d, y_enc)

print(f"Before balancing: {Counter(y_enc)}")
print(f"After SMOTE+ENN : {Counter(y_res)}")
